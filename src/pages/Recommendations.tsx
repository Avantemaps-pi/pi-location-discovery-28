  ...
  return <AppLayout title="Recommendations">
      <div className="w-full mx-auto mt-4 pb-6 overflow-y-auto overflow-x-hidden">
        <div className="space-y-4 sm:space-y-5 pb-1 px-0">
          ...
          data,
          key
        }) => <section key={key} onMouseEnter={() => handleMouseEnter(key)} onMouseLeave={handleMouseLeave} onTouchStart={() => handleMouseEnter(key)} className="relative w-full max-w-[92%] sm:max-w-[85%] md:max-w-[85%] mx-auto">
